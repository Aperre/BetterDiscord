...
class DankMemerHelper {
    ...
    start() {
        ...
        ZLibrary.PluginUpdater.checkForUpdate(this.getName(), this.getVersion(), "https://raw.githubusercontent.com/Aperre/BetterDiscord/master/DankMemerAddon.plugin.js");
    }
